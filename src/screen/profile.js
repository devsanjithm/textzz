      ...
      <View style={styles.main}>
        ...
        <View style={styles.mainname}>
          <Text style={styles.text}><Icons name="person"
            size={20} color="#8c8c8c" />    <Text style={{ color: "#494949" }}>Name:</Text>                   <View style={{ width: 50, height: 50 }}><Icon name="edit" onPress={() => navigation.navigate('Nameedit')} size={30} color="#1e88e5" /></View>{"\n"}        {userinfo.Displayname}     </Text>
          ...
          <Text style={styles.text}><Icon name="phone"
            size={20} color="#8c8c8c" />    <Text style={{ color: "#494949" }}>PhoneNumber:</Text>        <View style={{ width: 50, height: 50 }}><Icon name="edit" onPress={() => navigation.navigate('Phoneedit')} size={30} color="#1e88e5" /></View>{"\n"}        +91 {userinfo.PhoneNumber}
          </Text>
        </View>
